<template>
  <div>
    <el-row :gutter="10" style="margin-bottom: 15px">
      <el-col :span="2"><span style="font-weight:800; font-size:20px">库存查询</span></el-col>
      <el-col :span="6"><el-input clearable v-model="itemCode" placeholder="输入查询的商品编码"></el-input></el-col>
      <el-col :span="2" class="center"><el-switch v-model="cancel" active-text="显示停用"></el-switch></el-col>
      <el-col :span="6"><el-button type="primary" @click="queryInventory">查询</el-button></el-col>
    </el-row>
    <el-table :data="tableData" style="width: 100%" size="mini">
      <el-table-column fixed prop="item_code" label="商品编号" sortable max-width="150"></el-table-column>
